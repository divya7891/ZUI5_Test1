...
jQuery.sap.declare("try.Component");
jQuery.sap.require("sap.ui.core.UIComponent");
jQuery.sap.require("sap.ui.core.routing.History");
jQuery.sap.require("sap.m.routing.RouteMatchedHandler");

sap.ui.core.UIComponent.extend("try.Component", {
	metadata: {
		"name": "ZUI5_Test1",
	...
	init: function() {
		...
		var sRootPath = jQuery.sap.getModulePath("try");
	...
	_initODataModel: function(sServiceUrl) {
		jQuery.sap.require("try.util.messages");
		var oConfig = {
			metadataUrlParams: {},
			json: true,
		...
		oModel.attachRequestFailed(null,
			try.util.messages.showErrorMessage);
